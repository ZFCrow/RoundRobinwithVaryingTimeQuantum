...
void executeProcessFromQueue(readyQueue *queue, int quantumTime, readyQueue *finishedQueue){
...
// void removefromReadyQueue(readyQueue *queue, process *process){
//     if(queue->frontprocesses == process){
//         queue->frontprocesses = process->next;
//     }else{
//         process *temp = queue->frontprocesses;
...
void printReadyQueue(readyQueue *queue,int status){
    process *temp = queue->frontprocesses;
    if (status){
...
void calculateMediumBurstTime(readyQueue *queue){
...
void sortintoDoubleQueue(readyQueue *queue, readyQueue *lightTasksQueue, readyQueue *heavyTasksQueue){
    process *temp = queue->frontprocesses;
    while(temp != NULL){
...
bool isProcessInQueue(readyQueue *queue, int processId) {
...
int main(){
        ...
        readyQueue *finishedQueue = (readyQueue *)malloc(sizeof(readyQueue));

        //create the light tasks queue
        readyQueue *lightTasksQueue = (readyQueue *)malloc(sizeof(readyQueue));
        lightTasksQueue->frontprocesses = NULL;
        lightTasksQueue->rearprocesses = NULL;
        lightTasksQueue->size = 0;

        //create the heavy tasks queue
        readyQueue *heavyTasksQueue = (readyQueue *)malloc(sizeof(readyQueue));
